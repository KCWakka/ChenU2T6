    public class Student {
        ...
        public String getStudentInfo() {
            String msg = "Student Full Name: " + firstName + " " + lastName + "\n";
            msg += "Graduation Year: " + gradYear + "\n";
            msg += "Number of tests: " + testScoreCount + "\n";
            msg += "Average Test Score: " + averageTestScore() + "\n";
            msg += "Is passing: " + isPassing();
            return msg;
        }
    }